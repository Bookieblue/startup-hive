...
import ClaimStartupVerifyOtpForm from '@/components/forms/claimStartupVerifyOtp';

const ConfirmOtp = () => {
  return (
    <section className="max-container padding-container bg-cream-50 gap-10 pt-7 lg:pt-10 lg:px-24 lg:gap-10 2xl:pt-10 ">
    <div>
