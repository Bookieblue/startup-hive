...
const FormSchema = z.object({
    ...
    confirmPassword: z.string().min(1, "Password confirmation is required").min(8, "Password must have 8 characters"),
...
const SetPasswordForm = () => {
  ...
  return (
    <Form {...form}>
    <form onSubmit={form.handleSubmit(onSubmit)} className="mt-5 space-y-4 mb-28 lg:mb-48 ">
    <FormField
