    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="my-5 ">
        ...
        <TextareaInput 
         control={form.control}
         name="startup-names"
         label="Startup name(s)"
         placeholder="eg Paystack.com, Okra.ng, Kasha.com"
         className='h-40'
        />
        </div>
        <div className="flex gap-5 flex-col lg:flex-row mt-5 ">
        <TextareaInput 
         ...
         name="startup-names"
         label="Special note"
         placeholder="Any suggestion, feedback, comment for us?"
         className='h-20'
        />
        </div>
        <div className="mt-5">
...
export default SuggestStartupForm;
